...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Ninjapear.CompetitorCompany();
  });
  ...
  describe('CompetitorCompany', function() {
    it('should create an instance of CompetitorCompany', function() {
      // uncomment below and update the code to test CompetitorCompany
      //var instance = new Ninjapear.CompetitorCompany();
      //expect(instance).to.be.a(Ninjapear.CompetitorCompany);
    });

    it('should have the property companyDetailsUrl (base name: "company_details_url")', function() {
      // uncomment below and update the code to test the property companyDetailsUrl
      //var instance = new Ninjapear.CompetitorCompany();
    ...
    it('should have the property competitionReason (base name: "competition_reason")', function() {
      // uncomment below and update the code to test the property competitionReason
      //var instance = new Ninjapear.CompetitorCompany();
      //expect(instance).to.be();
    });
