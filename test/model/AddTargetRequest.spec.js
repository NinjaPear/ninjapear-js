...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Ninjapear.AddTargetRequest();
  });
  ...
  describe('AddTargetRequest', function() {
    it('should create an instance of AddTargetRequest', function() {
      // uncomment below and update the code to test AddTargetRequest
      //var instance = new Ninjapear.AddTargetRequest();
      //expect(instance).to.be.a(Ninjapear.AddTargetRequest);
    });
