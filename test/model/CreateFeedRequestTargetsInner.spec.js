...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Ninjapear.CreateFeedRequestTargetsInner();
  });
  ...
  describe('CreateFeedRequestTargetsInner', function() {
    it('should create an instance of CreateFeedRequestTargetsInner', function() {
      // uncomment below and update the code to test CreateFeedRequestTargetsInner
      //var instance = new Ninjapear.CreateFeedRequestTargetsInner();
      //expect(instance).to.be.a(Ninjapear.CreateFeedRequestTargetsInner);
    });
