...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Ninjapear.UpdateTargetRequest();
  });
  ...
  describe('UpdateTargetRequest', function() {
    it('should create an instance of UpdateTargetRequest', function() {
      // uncomment below and update the code to test UpdateTargetRequest
      //var instance = new Ninjapear.UpdateTargetRequest();
      //expect(instance).to.be.a(Ninjapear.UpdateTargetRequest);
    });
