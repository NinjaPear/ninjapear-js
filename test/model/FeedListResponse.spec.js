...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Ninjapear.FeedListResponse();
  });
  ...
  describe('FeedListResponse', function() {
    it('should create an instance of FeedListResponse', function() {
      // uncomment below and update the code to test FeedListResponse
      //var instance = new Ninjapear.FeedListResponse();
      //expect(instance).to.be.a(Ninjapear.FeedListResponse);
    });
