...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Ninjapear.CompanyWebsiteResponse();
  });
  ...
  describe('CompanyWebsiteResponse', function() {
    it('should create an instance of CompanyWebsiteResponse', function() {
      // uncomment below and update the code to test CompanyWebsiteResponse
      //var instance = new Ninjapear.CompanyWebsiteResponse();
      //expect(instance).to.be.a(Ninjapear.CompanyWebsiteResponse);
    });
