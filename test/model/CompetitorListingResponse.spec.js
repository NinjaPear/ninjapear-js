...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Ninjapear.CompetitorListingResponse();
  });
  ...
  describe('CompetitorListingResponse', function() {
    it('should create an instance of CompetitorListingResponse', function() {
      // uncomment below and update the code to test CompetitorListingResponse
      //var instance = new Ninjapear.CompetitorListingResponse();
      //expect(instance).to.be.a(Ninjapear.CompetitorListingResponse);
    });

    it('should have the property competitors (base name: "competitors")', function() {
      // uncomment below and update the code to test the property competitors
      //var instance = new Ninjapear.CompetitorListingResponse();
