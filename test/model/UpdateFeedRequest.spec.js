...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Ninjapear.UpdateFeedRequest();
  });
  ...
  describe('UpdateFeedRequest', function() {
    it('should create an instance of UpdateFeedRequest', function() {
      // uncomment below and update the code to test UpdateFeedRequest
      //var instance = new Ninjapear.UpdateFeedRequest();
      //expect(instance).to.be.a(Ninjapear.UpdateFeedRequest);
    });
