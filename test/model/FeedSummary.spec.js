...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Ninjapear.FeedSummary();
  });
  ...
  describe('FeedSummary', function() {
    it('should create an instance of FeedSummary', function() {
      // uncomment below and update the code to test FeedSummary
      //var instance = new Ninjapear.FeedSummary();
      //expect(instance).to.be.a(Ninjapear.FeedSummary);
    });
    ...
    it('should have the property targetCount (base name: "target_count")', function() {
