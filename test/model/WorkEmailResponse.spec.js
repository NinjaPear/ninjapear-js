...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Ninjapear.WorkEmailResponse();
  });
  ...
  describe('WorkEmailResponse', function() {
    it('should create an instance of WorkEmailResponse', function() {
      // uncomment below and update the code to test WorkEmailResponse
      //var instance = new Ninjapear.WorkEmailResponse();
      //expect(instance).to.be.a(Ninjapear.WorkEmailResponse);
    });
