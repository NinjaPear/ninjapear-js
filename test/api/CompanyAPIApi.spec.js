...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NinjaPear.CompanyAPIApi();
  });
  ...
  describe('CompanyAPIApi', function() {
    describe('getCompanyLogo', function() {
      it('should call getCompanyLogo successfully', function(done) {
        //uncomment below and update the code to test getCompanyLogo
        //instance.getCompanyLogo(function(error) {
