...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Ninjapear.CompetitorAPIApi();
  });
  ...
  describe('CompetitorAPIApi', function() {
    describe('getCompetitorListing', function() {
      it('should call getCompetitorListing successfully', function(done) {
        //uncomment below and update the code to test getCompetitorListing
        //instance.getCompetitorListing(function(error) {
