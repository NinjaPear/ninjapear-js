...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NinjaPear.ContactAPIApi();
  });
  ...
  describe('ContactAPIApi', function() {
    describe('checkDisposableEmail', function() {
      it('should call checkDisposableEmail successfully', function(done) {
        //uncomment below and update the code to test checkDisposableEmail
        //instance.checkDisposableEmail(function(error) {
