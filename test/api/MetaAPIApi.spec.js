...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NinjaPear.MetaAPIApi();
  });
  ...
  describe('MetaAPIApi', function() {
    describe('getCreditBalance', function() {
      it('should call getCreditBalance successfully', function(done) {
        //uncomment below and update the code to test getCreditBalance
        //instance.getCreditBalance(function(error) {
