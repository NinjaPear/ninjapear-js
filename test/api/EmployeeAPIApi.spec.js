...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Ninjapear.EmployeeAPIApi();
  });
  ...
  describe('EmployeeAPIApi', function() {
    describe('getPersonProfile', function() {
      it('should call getPersonProfile successfully', function(done) {
        //uncomment below and update the code to test getPersonProfile
        //instance.getPersonProfile(function(error) {
