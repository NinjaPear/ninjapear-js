...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NinjaPear.CustomerAPIApi();
  });
  ...
  describe('CustomerAPIApi', function() {
    describe('getCustomerListing', function() {
      it('should call getCustomerListing successfully', function(done) {
        //uncomment below and update the code to test getCustomerListing
        //instance.getCustomerListing(function(error) {
