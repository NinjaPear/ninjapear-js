...
------------- | ------------- | -------------
[**addTarget**](MonitorAPIApi.md#addTarget) | **POST** /api/v1/monitor/feeds/{feed_id}/targets | Add Target
[**createFeed**](MonitorAPIApi.md#createFeed) | **POST** /api/v1/monitor/feeds | Create Feed
[**deleteFeed**](MonitorAPIApi.md#deleteFeed) | **DELETE** /api/v1/monitor/feeds/{feed_id} | Delete Feed
[**deleteTarget**](MonitorAPIApi.md#deleteTarget) | **DELETE** /api/v1/monitor/feeds/{feed_id}/targets/{target_id} | Delete Target
[**getFeed**](MonitorAPIApi.md#getFeed) | **GET** /api/v1/monitor/feeds/{feed_id} | Get Feed
[**getRssFeed**](MonitorAPIApi.md#getRssFeed) | **GET** /api/v1/monitor/feeds/{feed_id}/rss.xml | Get RSS Feed
[**listFeeds**](MonitorAPIApi.md#listFeeds) | **GET** /api/v1/monitor/feeds | List Feeds
[**updateFeed**](MonitorAPIApi.md#updateFeed) | **PATCH** /api/v1/monitor/feeds/{feed_id} | Update Feed
[**updateTarget**](MonitorAPIApi.md#updateTarget) | **PATCH** /api/v1/monitor/feeds/{feed_id}/targets/{target_id} | Update Target
...
let apiInstance = new Ninjapear.MonitorAPIApi();
