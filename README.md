...
var website = "https://www.stripe.com"; // {String} The website URL or company name of the target company. A website URL (e.g. `https://www.stripe.com`) is strongly recommended for precision.
var opts = {
...
*Ninjapear.EmployeeAPIApi* | [**getWorkEmail**](docs/EmployeeAPIApi.md#getWorkEmail) | **GET** /api/v1/employee/work-email | Work Email Lookup
...
## Documentation for Models
 ...
 - [Ninjapear.WorkEmailResponse](docs/WorkEmailResponse.md)
